    ...
    */
    ...
    nv.models.distroPlot = function () {
        ...
        function clampViolinKDE(kde, extent) {
            ...
            if (extent[0] < clamped[0].x) clamped.unshift({
                x: extent[0],
                y: clamped[0].y
            })
            ...
            if (notchBox) {
                ...
                boxPoints = [
                    ...
                    },
                    {
                        x: boxLeft,
                        y: yScale(y)
                    }, // repeated point so that transition between notched/regular more smooth
                    {
                        x: boxLeft,
                        y: yScale(y)
                    },
    ...
    nv.models.distroPlotChart = function () {
        ...
        var renderWatch = nv.utils.renderWatch(dispatch, duration);
        var colorGroup0, marginTop0 = margin.top,
            x0, y0, resolution0, bandwidth0, clampViolin0;
        var dataCache;
    ...
    */
    ...
    nv.models.heatMap = function () {
        ...
        var margin = {
            ...
            id = Math.floor(Math.random() * 10000) //Create semi-unique ID in case user doesn't select one
            ,
            container, xScale = d3.scale.ordinal(),
            ...
            xDomain, yDomain, xMetaColorScale = nv.utils.defaultColor(),
            yMetaColorScale = nv.utils.defaultColor(),
            missingDataColor = '#bcbcbc',
            missingDataLabel = '',
            metaOffset = 5 // spacing between meta rects and cells
            ,
            xRange, yRange, xMeta, yMeta, colorRange, colorDomain, dispatch = d3.dispatch('chartClick', 'elementClick', 'elementDblClick', 'elementMouseover', 'elementMouseout', 'elementMousemove', 'renderEnd'),
            duration = 250,
